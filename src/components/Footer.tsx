                            ...
                            <div className="relative flex items-center px-6 py-6 sm:py-8 lg:mt-0">
                                ...
                                <div className="text-center relative mx-auto max-w-sm">
                                    ...
                                    <p className="mt-2 text-sm text-muted-foreground">
                                        ...
                                        you can do so in minutes. <br />
                                        <Link className="whitespace-nowrap font-medium text-blue-600 hover:text-blue-500 group transition" href="/sign-in?as=seller">
                                            Get started <span className="group-hover:ml-0.5 transition">&rarr;</span>
                                        </Link>
                                    </p>
                                </div>
                            </div>
