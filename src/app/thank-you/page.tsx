          ...
          <div className='lg:col-start-2'>
            ...
            {order._isPaid ? (
              ...
              <p className="mt-2 text-muted-foreground">
                ...
                it. So hang in tight and We&apos;ll send you a confirmation very soon!
              </p>
            )}
            ...
            <div className="mt-16 text-sm font-medium">
              ...
              <ul className="mt-6 divide-y divide-gray-200 border-t border-gray-200 text-sm font-medium text-muted-foreground">
                {(order.products as Product[]).map((product, idx) => {
                  const label = PRODUCT_CATEGORIES
                    .find((p) => p.value === product.category)
                    ?.label;
                  ...
                  return (
                    <li key={`product-${idx}-${product.id}`} className="flex space-x-6">
              ...
              <div className="mt-16 border-t border-gray-200 py-6 text-right">
                <Link href="/products" className="text-sm font-medium text-blue-600 hover:text-blue-500 group">
                  Continue shoping <span className="group-hover:ml-1 transition-all">&rarr;</span>
                </Link>
              </div>
            </div>
          </div>
