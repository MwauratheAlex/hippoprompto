...
const ReceiptEmail = ({ email, date, orderId, products }) => {
    const total = products.reduce((acc, curr) => acc + curr.price, 0) + 100;
...
const ReceiptEmailHtml = (props) => (0, components_1.render)(React.createElement(exports.ReceiptEmail, Object.assign({}, props)), { pretty: true });
